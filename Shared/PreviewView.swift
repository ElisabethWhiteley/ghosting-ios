...
final class PreviewMetalView: MTKView {
    ...
    init(device: MTLDevice?, imagePublisher: AnyPublisher<(CIImage?, Bool?), Never>) {
...
struct PreviewView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        PreviewView(imagePublisher: Just((previewImage, true)).eraseToAnyPublisher())
    }
}
