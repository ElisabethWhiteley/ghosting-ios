    ...
    var body: some View {
        ...
        VStack {
            VStack {
                ...
                AchievementView(isRecording: soundManager.isRecording, showX: soundManager.responseState == .recognized, showGhost: soundManager.responseState == .responding).padding(.horizontal, 6)
